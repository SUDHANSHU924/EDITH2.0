  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(180deg, rgb(5,5,5) 0%, rgb(8,12,20) 100%)',
            ...
            {DEPARTMENTS.map((dept) => {
              ...
              return (
                <div key={dept.id} style={{ position: 'relative' }}>
                  {/* Outer glow ring — lives outside overflow:hidden so it's fully visible */}
                  <AnimatePresence>
                    {isActive && (
                      <motion.div
                        ...
                        style={{
                          ...
                          border: `1px solid ${deptColor}70`,
                          boxShadow: `0 0 18px ${deptColor}30, 0 0 36px ${deptColor}12, inset 0 0 12px ${deptColor}08`,
                ...
                <motion.button
                  ...
                  style={{
                    background: isActive ? `${deptColor}16` : 'transparent',
                    border: `1px solid ${isActive ? deptColor + '20' : 'transparent'}`,
                    position: 'relative', zIndex: 1,
                  }}
                  whileHover={{ scale: 1.02, background: `${deptColor}0e` }}
                  whileTap={{ scale: 0.97 }}
                ...
                >
                  <motion.div
                    ...
                    style={{
                      background: `radial-gradient(ellipse at left center, ${deptColor}14, transparent 65%)`,
                    }}
                  />
                  ...
                  <motion.div
                    ...
                    animate={{
                      ...
                      boxShadow: isActive ? `0 0 8px ${deptColor}` : 'none',
                    }}
                  ...
                  <motion.div
                    ...
                    animate={{
                      filter: isActive ? `drop-shadow(0 0 6px ${deptColor})` : 'none',
                    }}
                  >
                    <Icon
                      size={18}
          ...
          <AnimatePresence>
            {expanded ? (
              ...
              >
                ...
                <div className="flex justify-between items-center text-xs" style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px' }}>
                  <span className="text-white/30">THREAT</span>
                  <span style={{ color: securityMode ? '#F5A623' : '#2FD4A3' }} className="flex items-center gap-1">
                    <motion.span
